...
// Branded, email-client-safe HTML templates for SunSharp account emails.
      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:100%;">
        ...
        <tr><td align="center" style="background:linear-gradient(135deg,${BRAND.sun},${BRAND.orange});background-color:${BRAND.orange};border-radius:20px 20px 0 0;padding:28px 24px 24px;">
          ...
          <div style="margin-top:8px;font-family:${FONT};font-size:26px;font-weight:800;letter-spacing:-0.5px;">
            <span style="color:#ffffff;">Sun</span><span style="color:#0b3a66;">Sharp</span>
          </div>
        ...
        <tr><td style="background:${BRAND.card};border-radius:0 0 20px 20px;border-top:1px solid #eef2f7;padding:20px 32px 28px;">
          <p style="margin:0 0 8px;font-family:${FONT};font-size:12px;line-height:1.5;color:${BRAND.faint};">
            You're receiving this because you have a SunSharp account.
          </p>
          <p style="margin:0;font-family:${FONT};font-size:12px;line-height:1.5;color:${BRAND.faint};">
            ...
            <a href="${SITE}" style="color:${BRAND.muted};text-decoration:underline;">SunSharp</a>
          </p>
...
export function welcomeEmail(opts: { name?: string }): EmailContent {
  ...
  return {
    subject: "Welcome to SunSharp ☀️",
    html: layout({
      preheader: "Your SunSharp account is ready — add your first learner.",
      heading: "Welcome to SunSharp!",
      bodyHtml,
...
export function welcomeGuideEmail(opts: { name?: string }): EmailContent {
  ...
  const bodyHtml = `
    ...
    <p style="margin:0 0 6px;">SunSharp keeps kids sharp over the break with quick, fun daily practice. Here's everything you need to get going.</p>
    ...
    <p style="margin:0 0 14px;">Scan this with your child's iPad, tablet, or phone camera to open SunSharp right on their device:</p>
    <table role="presentation" cellpadding="0" cellspacing="0" align="center" style="margin:0 auto 10px;">
      <tr><td align="center" style="background:#ffffff;border:1px solid #eef2f7;border-radius:16px;padding:14px;">
        <img src="${SITE}/install-qr.png" width="180" height="180" alt="Scan to open SunSharp" style="display:block;width:180px;height:180px;border-radius:8px;">
      </td></tr>
    </table>
    <p style="margin:0 0 4px;font-size:14px;color:${BRAND.faint};text-align:center;">Or just open <a href="${SITE}" style="color:${BRAND.blue};text-decoration:underline;">SunSharp</a> in the device's browser.</p>

    <h2 style="${h2}">⬇️ Install it like an app (no app store)</h2>
    <p style="margin:0 0 12px;">Make SunSharp open full-screen like a real app, with its own home-screen icon:</p>
    <ul style="margin:0;padding-left:20px;">
  ...
  return {
    subject: "Welcome to SunSharp — get it on your kid's device 📱",
    html: layout({
      preheader:
        "How SunSharp works, plus how to add it to your child's iPad, tablet or phone.",
