...
('math','K',1,'MA.K.NSO.2','Which number is bigger?', '["7","4","2","1"]', 0, '7 is the biggest number in the list.', 10),
...
('math','1',1,'MA.1.NSO.1','Which sign makes it true?  6 ___ 9', '[">","<","=","+"]', 1, '6 is less than 9, so we use the < sign.', 10),
('math','1',2,'MA.1.NSO.2','Count by 10s: 10, 20, 30, ?', '["31","40","35","50"]', 1, 'Counting by tens, after 30 comes 40.', 10),
('math','1',1,'MA.1.GR.1','How many sides does a triangle have?', '["2","3","4","5"]', 1, 'A triangle always has 3 sides.', 10),
-- ===== MATH: Grade 2 =====
...
('math','4',2,'MA.4.FR.1','0.7 written as a fraction is:', '["7/10","7/100","1/7","70"]', 0, '0.7 means 7 tenths, which is 7/10.', 15),
('math','4',3,'MA.4.AR.3','A factor pair of 24 is:', '["5 and 5","3 and 8","7 and 4","6 and 5"]', 1, '3 × 8 = 24, so 3 and 8 are factors of 24.', 15),
...
('math','5',3,'MA.5.GR.3','A box is 2 × 3 × 4. What is its volume?', '["9","24","14","20"]', 1, 'Volume = length × width × height = 2 × 3 × 4 = 24.', 15),
('math','5',2,'MA.5.NSO.2','12.5 × 10 = ?', '["1.25","125","1250","12.50"]', 1, 'Multiplying by 10 moves the decimal one place right: 125.', 15),
('math','5',3,'MA.5.NSO.1','Which decimal is the largest?', '["0.5","0.45","0.09","0.5 and 0.45 are equal"]', 0, '0.5 is the same as 0.50, which is larger than 0.45 and 0.09.', 15),
